...
class YoutubeSpider(BaseSpider):
    ...
    def __init__(self, *args, **kwargs):
        self.conn = MySQLdb.connect(host="localhost", user="user name", passwd='pwd', db="DB_NAME", charset='utf8', use_unicode=True)
    ...
    def parse_next(self, response):
        ...
        for image_node in image_nodes:
            ...
            qry = 'insert into images (title, image_desc, image_1, image_2) values (%s, %s, %s, %s) on duplicate key udpate title = %s'
